...
export const API = {
  ...
  SENDOTP: (phone, callingCode) => `api/auth/otp/create?phone=${phone}&countryCode=${callingCode}`,
  VERIFYOTP: (phone, countryCode, otp) => `api/auth/otp/verify?phone=${phone}&countryCode=${countryCode}&otp=${otp}`,
  ...
  VERIFYFORGETPASSWORDOTP: (phone, otp, clientId, countryCode) => `api/auth/otp/verify?phone=${phone}&countryCode=${countryCode}&otp=${otp}&tokenRequired=true&client_id=${clientId}`,
